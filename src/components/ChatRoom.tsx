    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Message Input */}
          <div className="p-4 border-2 border-red-500 bg-yellow-100 flex-shrink-0">
            <div className="flex items-center space-x-2">
              {/* Attachment Button */}
              <Button
                variant="ghost"
            ...
            {/* Recording Indicator */}
            {/* isRecording state is not defined in the original file, so this block is commented out */}
            {/* {isRecording && (
